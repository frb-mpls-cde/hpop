...
The current version of the HPOP datasets reflects information (see below) as of **July 2026**. 
...
The HPOP datasets are derived from American Community Survey (ACS) data.
